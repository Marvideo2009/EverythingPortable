...
:Menu
cls
title Portable UwAmp Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall uwamp [will remove uwamp entirely]
echo 2. launch uwamp [launches uwamp]
echo 3. reset uwamp [will remove everything uwamp except the binary]
echo 4. uninstall uwamp [none of your friends on uwamp?]
...
echo d. check for new uwamp version [automatically check for a new version]
...
:2
:LaunchUwAmp
if not exist ".\bin\UwAmp\UwAmp.exe" set "nag=PLEASE INSTALL UWAMP FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo UWAMP IS RUNNING
...
echo y | if exist .\bin\UwAmp\*.* del .\bin\UwAmp\*.* >nul
if exist .\extra\UwAmp.zip del .\extra\UwAmp.zip >nul
exit /b 2
...
cls
title Portable UwAmp Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable UwAmp Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable UwAmp Launcher - Helper Edition - Download Suite
...
title Portable UwAmp Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start .\bin\UwAmp\uwamp.exe>>!quick_launcher!
...
call :HelperDownload "https://www.uwamp.com/file/UwAmp.zip" "UwAmp.zip"
:MoveUwAmp
move UwAmp.zip .\extra\UwAmp.zip
:ExtractUwAmp
call :HelperExtract "!folder!\extra\UwAmp.zip" "!folder!\bin\"
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\UwAmp.zip")
exit /b 2

:e
title Portable UwAmp Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\UwAmp\UwAmp.exe" set nag=UWAMP IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable UwAmp Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable UwAmp Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable UwAmp Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable UwAmp Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable UwAmp Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable UwAmp Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
