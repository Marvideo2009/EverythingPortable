...
:Menu
cls
title Portable NTLite Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall ntlite [will remove ntlite entirely]
echo 2. launch ntlite [launches ntlite]
echo 3. reset ntlite [will remove everything ntlite except the binary]
echo 4. uninstall ntlite [i dont actually know what ntlite is no quirky comment]
...
echo d. check for new ntlite version [automatically check for a new version]
...
:2
:LaunchNTLite
if not exist ".\bin\ntlite\!arch!\NTLite.exe" set "nag=PLEASE INSTALL NTLITE FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo YOU REQUIRE ADMIN BTW PRESS ENTER TO CONTINUE & pause >nul
echo NTLITE IS RUNNING
...
cls
title Portable NTLite Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable NTLite Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable NTLite Launcher - Helper Edition - Download Suite
...
title Portable NTLite Launcher - Helper Edition - Quicklauncher Writer
...
echo set "arch=x86">>!quick_launcher!
echo if exist "%%PROGRAMFILES(X86)%%" set "arch=x64">>!quick_launcher!
echo cls>>!quick_launcher!
echo echo YOU REQUIRE ADMIN BTW PRESS ENTER TO CONTINUE ^& pause^ >nul>>!quick_launcher!
echo start .\bin\ntlite\%%arch%%\NTLite.exe>>!quick_launcher!
...
if exist NTLite_setup_x86.exe del NTLite_setup_x86.exe >nul
if exist NTLite_setup_x64.exe del NTLite_setup_x64.exe >nul
call :HelperDownload "https://downloads.ntlite.com/files/NTLite_setup_x86.exe" "NTLite_setup_x86.exe"
call :HelperDownload "https://downloads.ntlite.com/files/NTLite_setup_x64.exe" "NTLite_setup_x64.exe"
:MoveNTLite
move NTLite_setup_x86.exe .\extra\NTLite_setup_x86.exe
move NTLite_setup_x64.exe .\extra\NTLite_setup_x64.exe
:ExtractNTLite
call :HelperExtractInno "!folder!\extra\NTLite_setup_x86.exe" "!folder!\temp\x86\"
call :HelperExtractInno "!folder!\extra\NTLite_setup_x64.exe" "!folder!\temp\x64\"
xcopy .\temp\x86\{app}\* .\bin\ntlite\x86\ /e /i /y
xcopy .\temp\x64\{app}\* .\bin\ntlite\x64\ /e /i /y
if exist .\temp\ rmdir /s /q .\temp\
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\NTLite_setup_x86.exe" & echo.>".\extra\NTLite_setup_x64.exe")
exit /b 2

:e
title Portable NTLite Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\ntlite\!arch!\NTLite.exe" set nag=NTLITE IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable NTLite Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable NTLite Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable NTLite Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable NTLite Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable NTLite Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable NTLite Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
