...
:Menu
cls
title Portable Epic Games Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall epic games [will remove epic games entirely]
echo 2. launch epic games [launches epic games]
echo 3. reset epic games [will remove everything epic games except the binary]
echo 4. uninstall epic games [none of your friends on epic games?]
...
cls
title Portable Epic Games Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Epic Games Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Epic Games Launcher - Helper Edition - Download Suite
...
title Portable Epic Games Launcher - Helper Edition - Quicklauncher Writer
...
call :HelperDownload "https://launcher-public-service-prod06.ol.epicgames.com/launcher/api/installer/download/EpicGamesLauncherInstaller.msi" "EpicGamesLauncherInstaller.msi"
:MoveEpicGames
move EpicGamesLauncherInstaller.msi .\extra\EpicGamesLauncherInstaller.msi
:ExtractEpicGames
call :HelperExtractMSI "!folder!\extra\EpicGamesLauncherInstaller.msi" "!folder!\temp\"
xcopy ".\temp\SourceDir\Epic Games\*" ".\bin\epic_games\" /e /i /y
xcopy ".\temp\SourceDir\Epic\EpicGamesLauncher\Data\EMS\EpicGamesLauncher\*" ".\data\Users\MarioMasta64\AppData\Local\EpicGamesLauncher\Saved\Config\Windows\" /e /i /y
xcopy ".\temp\SourceDir\System\*" ".\dll\32\" /e /i /y
xcopy ".\temp\SourceDir\System64\*" ".\dll\64\" /e /i /y
if exist .\temp\ rmdir /s /q .\temp\
:InstallPreReq
call :HelperExtractDirectX
cls
title README README README README
REM echo NOTE: ADMIN IS REQUIRED THE FIRST TIME YOU RUN THROUGH ON A COMPUTER
REM echo ONCE YOU HAVE DONE IT THE FIRST TIME YOU MAY BE ON A BLACK SCREEN RIGHT CLICK
...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\EpicGamesLauncherInstaller.msi")
exit /b 2

:e
title Portable Epic Games Launcher - Helper Edition - Text-Reader Update Check
cls
...
xcopy ".\temp\SourceDir\System64\*" ".\dll\64\" /e /i /y
xcopy ".\temp\SourceDir\Win\System64\*" ".\dll\64\" /e /i /y
if exist .\temp\ rmdir /s /q .\temp\
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Epic Games Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Epic Games Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Epic Games Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Epic Games Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Epic Games Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Epic Games Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
