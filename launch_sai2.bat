...
:Menu
cls
title Portable SAI2 Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall sai2 [will remove sai2 entirely]
echo 2. launch sai2 [launches sai2]
echo 3. reset sai2 [will remove everything sai2 except the binary]
echo 4. uninstall sai2 [feel a bit limited?]
...
:2
:LaunchSAI2
if not exist ".\bin\sai2\!arch!Bit\sai2.exe" set "nag=PLEASE INSTALL SAI2 FIRST" & exit /b 2
title DO NOT CLOSE
set "Path=!PATH!;!folder!\dll\!arch!\;"
cls
echo SAI2 IS RUNNING
start "" ".\bin\sai2\!arch!Bit\sai2.exe"
exit
...
if exist ".\data\Users\MarioMasta64\AppData\Local\SYSTEMAX Software Development\" rmdir /s /q ".\data\Users\MarioMasta64\AppData\Local\SYSTEMAX Software Development\"
exit /b 2
...
cls
taskkill /f /im sai2.exe
if exist .\bin\sai2\ rmdir /s /q .\bin\sai2\
if exist .\extra\sai2*.zip del .\extra\sai2*.zip >nul
exit /b 2
...
cls
title Portable SAI2 Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable SAI2 Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable SAI2 Launcher - Helper Edition - Download Suite
...
title Portable SAI2 Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start "" ".\bin\sai2\%%arch%%Bit\sai2.exe">>!quick_launcher!
...
cls
echo upgrading to sai2 v!sai2_zip:~5,-13!
call :HelperDownload "!sai2_link32!" "!sai2_zip32!"
call :HelperDownload "!sai2_link64!" "!sai2_zip64!"
:MoveSAI2
move "!sai2_zip32!" ".\extra\!sai2_zip32!"
move "!sai2_zip64!" ".\extra\!sai2_zip64!"
:ExtractSAI2
...
:e
title Portable SAI2 Launcher - Helper Edition - Text-Reader Update Check
cls
...
echo ================================================== >> !license!
cls
title Portable SAI2 Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable SAI2 Launcher - Helper Edition - Latest Build :D
...
:PreviewBuild
cls
title Portable SAI2 Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable SAI2 Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
