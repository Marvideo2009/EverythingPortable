...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\!obs_classic_zip!")
exit /b 2
...
call :HelperDownload "https://raw.githubusercontent.com/Marvideo2009/EverythingPortable/master/launch_obs.bat" "launch_obs.bat.1"
