...
:Menu
cls
title Portable Bitwarden Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall bitwarden [will remove bitwarden entirely]
echo 2. launch bitwarden [launches bitwarden]
echo 3. reset bitwarden [will remove everything bitwarden except the binary]
echo 4. uninstall bitwarden [???]
...
echo d. check for new bitwarden version [automatically check for a new version]=
...
call :UpgradeBitwarden
exit /b 2

:2
:LaunchBitwarden
if not exist ".\bin\bitwarden\!arch!Bit\Bitwarden.exe" set "nag=PLEASE INSTALL BITWARDEN FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo BITWARDEN IS RUNNING
start "" ".\bin\bitwarden\!arch!Bit\Bitwarden.exe"
exit
...
if exist .\extra\Bitwarden-Portable.exe del .\extra\Bitwarden-Portable.exe >nul
exit /b 2
...
cls
title Portable Bitwarden Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Bitwarden Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Bitwarden Launcher - Helper Edition - Download Suite
...
title Portable Bitwarden Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start "" ".\bin\bitwarden\%%arch%%Bit\Bitwarden.exe">>!quick_launcher!
...
call :HelperDownload "https://vault.bitwarden.com/download/?app=desktop&platform=windows&variant=portable" "index.html@app=desktop&platform=windows&variant=portable"
:MoveBitwarden
move "index.html@app=desktop&platform=windows&variant=portable" ".\extra\Bitwarden-Portable.exe"
:ExtractBitwarden
call :HelperExtract7Zip "!folder!\extra\Bitwarden-Portable.exe" "!folder!\temp\"
call :HelperExtract7Zip "!folder!\temp\$PLUGINSDIR\app-32.7z" "!folder!\bin\bitwarden\32Bit\"
call :HelperExtract7Zip "!folder!\temp\$PLUGINSDIR\app-64.7z" "!folder!\bin\bitwarden\64Bit\"
if exist .\temp\ rmdir /s /q .\temp\
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\Bitwarden-Portable.exe")
exit /b 2

:e
title Portable Bitwarden Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\bitwarden\!arch!Bit\Bitwarden.exe" set nag=BITWARDEN IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Bitwarden Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Bitwarden Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Bitwarden Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Bitwarden Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Bitwarden Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Bitwarden Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
