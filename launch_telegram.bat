...
:2
:LaunchTelegram
if not exist ".\bin\telegram\Telegram.exe" set "nag=PLEASE INSTALL TELEGRAM FIRST" & exit /b 2
title DO NOT CLOSE
cls
...
echo cls>>!quick_launcher!
echo start .\bin\telegram\Telegram.exe>>!quick_launcher!
...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\win!arch!_portable.zip")
exit /b 2
