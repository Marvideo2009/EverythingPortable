...
:Menu
cls
title Portable Thunderbird Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall thunderbird [will remove thunderbird entirely]
echo 2. launch thunderbird [launches thunderbird]
echo 3. reset thunderbird [will remove everything thunderbird except the binary]
echo 4. uninstall thunderbird [none of your friends on thunderbird?]
...
echo d. check for new thunderbird version [automatically check for a new version]
...
:1
:ReinstallThunderbird
cls
call :UninstallThunderbird
call :UpgradeThunderbird
exit /b 2

:2
:LaunchThunderbird
if not exist ".\bin\thunderbird\!arch!\thunderbird.exe" set "nag=PLEASE INSTALL THUNDERBIRD FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo THUNDERBIRD IS RUNNING
start .\bin\thunderbird\!arch!\thunderbird.exe  -profile "!folder!\data\thunderbird"
exit
...
cls
title Portable Thunderbird Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Thunderbird Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Thunderbird Launcher - Helper Edition - Download Suite
...
title Portable Thunderbird Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start .\bin\thunderbird\%%arch%%\thunderbird.exe  -profile "%%folder%%\data\thunderbird">>!quick_launcher!
...
:ExtractThunderbird
call :HelperExtract7Zip "!folder!\extra\Thunderbird Setup Win32.exe" "!folder!\bin\thunderbird\32\"
call :HelperExtract7Zip "!folder!\extra\Thunderbird Setup Win64.exe" "!folder!\bin\thunderbird\64\"
xcopy ".\bin\thunderbird\32\core\*" ".\bin\thunderbird\32\" /e /i /y
xcopy ".\bin\thunderbird\64\core\*" ".\bin\thunderbird\64\" /e /i /y
if exist ".\bin\thunderbird\32\setup.exe" del ".\bin\thunderbird\32\setup.exe" >nul
if exist ".\bin\thunderbird\64\setup.exe" del ".\bin\thunderbird\64\setup.exe" >nul
if exist ".\bin\thunderbird\32\Core\" rmdir /s /q ".\bin\thunderbird\32\Core\"
if exist ".\bin\thunderbird\64\Core\" rmdir /s /q ".\bin\thunderbird\64\Core\"
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\Thunderbird Setup Win32.exe" & echo.>".\extra\Thunderbird Setup Win64.exe")
exit /b 2

:e
title Portable Thunderbird Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\thunderbird\!arch!\thunderbird.exe" set nag=THUNDERBIRD IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Thunderbird Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Thunderbird Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Thunderbird Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Thunderbird Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Thunderbird Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Thunderbird Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
