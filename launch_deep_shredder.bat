...
:Menu
cls
title Portable Deep Shredder Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall deep shredder [will remove deep shredder entirely]
echo 2. launch deep shredder [launches deep shredder]
echo 3. reset deep shredder [will remove everything deep shredder except the binary]
echo 4. uninstall deep shredder [i dont know what this is?]
...
echo d. check for new deep shredder version [automatically check for a new version]
...
:1
:ReinstallDeepShredder
cls
call :UninstallDeepShredder
call :UpgradeDeepShredder
exit /b 2

:2
:LaunchDeepShredder
if not exist ".\bin\deep_shredder\Shredder.exe" set "nag=PLEASE INSTALL DEEP SHREDDER FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo DEEP SHREDDER IS RUNNING
start .\bin\deep_shredder\Shredder.exe
exit
...
cls
title Portable Deep Shredder Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Deep Shredder Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Deep Shredder Launcher - Helper Edition - Download Suite
...
title Portable Deep Shredder Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start .\bin\deep_shredder\Shredder.exe>>!quick_launcher!
...
call :HelperDownload "http://www.shredderchess.com/fgx/SetupDeepShredder12.exe" "SetupDeepShredder12.exe"
:MoveDeepShredder
move SetupDeepShredder12.exe .\extra\SetupDeepShredder12.exe
:ExtractDeepShredder
call :HelperExtractInno "!folder!\extra\SetupDeepShredder12.exe" "!folder!\temp\"
xcopy .\temp\{app}\* .\bin\deep_shredder\ /e /i /y
xcopy .\temp\{userappdata}\* .\data\Users\MarioMasta64\AppData\Roaming\ /e /i /y
xcopy .\temp\{userdocs}\* .\data\Documents\ /e /i /y
if exist .\temp\ rmdir /s /q .\temp\
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\SetupDeepShredder12.exe")
exit /b 2

:e
title Portable Deep Shredder Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\deep_shredder\Shredder.exe" set nag=DEEP SHREDDER IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Deep Shredder Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Deep Shredder Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Deep Shredder Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Deep Shredder Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Deep Shredder Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Deep Shredder Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
