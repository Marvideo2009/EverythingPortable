...
:2
:LaunchFirefox
if not exist ".\bin\firefox\firefox.exe" set "nag=PLEASE INSTALL FIREFOX FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo FIREFOX IS RUNNING
start .\bin\firefox\firefox.exe "https://github.com/Marvideo2009/EverythingPortable/" -profile "!folder!\data\firefox"
exit
...
if exist .\data\Users\MarioMasta64\AppData\Roaming\Mozilla\ rmdir /s /q .\data\Users\MarioMasta64\AppData\Roaming\Mozilla\
...
echo cls>>!quick_launcher!
echo start .\bin\firefox\firefox.exe "https://github.com/Marvideo2009/EverythingPortable/" -profile "%%folder%%\data\firefox">>!quick_launcher!
...
if exist "!firefox_zip!" del "!firefox_zip!" >nul
...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\!firefox_zip!")
exit /b 2
