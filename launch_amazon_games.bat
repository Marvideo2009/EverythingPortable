...
:Menu
cls
title Portable Amazon Games Launcher - Helper Edition - Main Menu
echo !NAG!
...
echo d. check for new amazon games version [automatically check for a new version]
...
:1
:ReinstallAmazonGames
cls
call :UninstallAmazonGames
call :UpgradeAmazonGames
exit /b 2

:2
:LaunchAmazonGames
if not exist ".\data\Users\MarioMasta64\AppData\Local\Amazon Games\App\Amazon Games.exe" set "nag=PLEASE INSTALL AMAZON GAMES FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo AMAZON GAMES IS RUNNING
start "" ".\data\Users\MarioMasta64\AppData\Local\Amazon Games\App\Amazon Games.exe"
exit
...
taskkill /f /im "Amazon Games UI.exe"
taskkill /f /im "Amazon Games Services.exe"
...
cls
title Portable Amazon Games Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Amazon Games Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Amazon Games Launcher - Helper Edition - Download Suite
...
title Portable Amazon Games Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start "" ".\data\Users\MarioMasta64\AppData\Local\Amazon Games\App\Amazon Games.exe">>!quick_launcher!
...
call :HelperDownload "https://download.amazongames.com/AmazonGamesSetup.exe" "AmazonGamesSetup.exe"
:MoveAmazonGames
...
:ExtractAmazonGames
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\AmazonGamesSetup.exe")
exit /b 2

:e
title Portable Amazon Games Launcher - Helper Edition - Text-Reader Update Check
cls
...
call :Null
REM cls
REM cant get the normal batch auto path linking to read the file because it cant tell the filetype and powershell also shits itself at this
REM powershell -command (Get-Content -path "!folder!\data\Users\MarioMasta64\AppData\Local\Amazon Games\Data\Games\Sql\GameInstallInfo.sqlite") -replace "G:\", "!folder:~0,3!" ^| Set-Content -Path "!folder!\data\Users\MarioMasta64\AppData\Local\Amazon Games\Data\Games\Sql\GameInstallInfo.sqlite"
REM powershell -command "(Get-Content '!folder!\data\Users\MarioMasta64\AppData\Local\Amazon Games\Data\Games\Sql\GameInstallInfo.sqlite') | Foreach-object {$_ -replace 'G:\', '!folder:~0,3!'} | set-content '!folder!\data\Users\MarioMasta64\AppData\Local\Amazon Games\Data\Games\Sql\GameInstallInfo.sqlite'"
REM pause
exit /b 2
...
if not exist ".\data\Users\MarioMasta64\AppData\Local\Amazon Games\App\Amazon Games.exe" set nag=AMAZON GAMES IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Amazon Games Launcher - Helper Edition - About
...
echo %8> .\helpers\versionstart.txt
...
:LatestBuild
cls
title Portable Amazon Games Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Amazon Games Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Amazon Games Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Amazon Games Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Amazon Games Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
