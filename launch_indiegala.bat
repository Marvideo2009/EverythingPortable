...
:Menu
cls
title Portable IndieGala Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall indiegala [will remove indiegala entirely]
echo 2. launch indiegala [launches indiegala]
echo 3. reset indiegala [will remove everything indiegala except the binary]
echo 4. uninstall indiegala [none of your friends on indiegala?]
...
echo d. check for new indiegala version [automatically check for a new version]
...
cls
title Portable IndieGala Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable IndieGala Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable IndieGala Launcher - Helper Edition - Download Suite
...
call :HelperDownload "https://content.indiegalacdn.com/common/IGClientSetup.exe" "IGClientSetup.exe"
:MoveIndieGala
move IGClientSetup.exe .\extra\IGClientSetup.exe
:ExtractIndieGala
call :HelperExtract7Zip "!folder!\extra\IGClientSetup.exe" "!folder!\temp\"
call :HelperExtract7Zip "!folder!\temp\$PLUGINSDIR\app-64.7z" "!folder!\bin\indiegala\"
if exist .\temp\ rmdir /s /q .\temp\
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\IGClientSetup.exe")
exit /b 2

:e
title Portable IndieGala Launcher - Helper Edition - Text-Reader Update Check
cls
...
echo ================================================== >> !license!
cls
title Portable IndieGala Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable IndieGala Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable IndieGala Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable IndieGala Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable IndieGala Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable IndieGala Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
