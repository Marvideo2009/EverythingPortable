...
:Menu
cls
title Portable Lightshot Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall lightshot [will remove lightshot entirely]
echo 2. launch lightshot [launches lightshot]
echo 3. reset lightshot [will remove everything lightshot except the binary]
echo 4. uninstall lightshot [none of your friends on lightshot?]
...
echo d. check for new lightshot version [automatically check for a new version]
...
cls
title Portable Lightshot Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Lightshot Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Lightshot Launcher - Helper Edition - Download Suite
...
title Portable Lightshot Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start .\bin\lightshot\lightshot.exe>>!quick_launcher!
...
call :HelperDownload "https://app.prntscr.com/build/setup-lightshot.exe" "setup-lightshot.exe"
:MoveLightshot
...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\setup-lightshot.exe")
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Lightshot Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Lightshot Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Lightshot Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Lightshot Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Lightshot Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Lightshot Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
