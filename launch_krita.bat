...
:Menu
cls
title Portable Krita Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall krita [will remove krita entirely]
echo 2. launch krita [launches krita]
echo 3. reset krita [will remove everything krita except the binary]
echo 4. uninstall krita [feel a bit limited?]
...
echo d. check for new krita version [automatically check for a new version]
...
:2
:LaunchKrita
if not exist ".\bin\krita\bin\krita.exe" set "nag=PLEASE INSTALL KRITA FIRST" & exit /b 2
title DO NOT CLOSE
set "Path=!PATH!;!folder!\dll\!arch!\;"
cls
echo KRITA IS RUNNING
pushd .\bin\krita\
%COMSPEC% /C start "" "%CD%\bin\krita.exe"
popd
exit
...
if exist .\data\Users\MarioMasta64\AppData\Local\krita\ rmdir /s /q .\data\Users\MarioMasta64\AppData\Local\krita\
if exist .\data\Users\MarioMasta64\AppData\Local\krita* del .\data\Users\MarioMasta64\AppData\Local\krita* >nul
if exist .\data\Users\MarioMasta64\AppData\Roaming\krita\ rmdir /s /q .\data\Users\MarioMasta64\AppData\Roaming\krita\
exit /b 2
...
cls
taskkill /f /im krita.exe
if exist .\bin\krita\ rmdir /s /q .\bin\krita\
if exist .\extra\krita*.zip del .\extra\krita*.zip >nul
exit /b 2
...
cls
title Portable Krita Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Krita Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Krita Launcher - Helper Edition - Download Suite
...
title Portable Krita Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo pushd .\bin\krita\>>!quick_launcher!
echo %%COMSPEC%% /C start "" "%%CD%%\bin\krita.exe">>!quick_launcher!
...
) Do > .\doc\krita_link.txt Echo:%%A
set /p krita_link=<.\doc\krita_link.txt
if "!Debug!" EQU "1" (
  echo !krita_link!
  echo !counter!
)
...
set "tempstr=!krita_link!"
set "result=%tempstr:/=" & set "result=%"
set "krita_zip=!result!"
if "!Debug!" EQU "1" (
  cls
  echo "!krita_zip:~10,-4!"
  echo "!krita_zip!"
...
if exist ".\extra\!krita_zip!" (
  echo krita is updated.
  pause
  exit /b 2
)
cls
echo upgrading to krita v!krita_zip:~10,-4!
call :HelperDownload "!krita_link!" "!krita_zip!"
:MoveKrita
move "!krita_zip!" ".\extra\!krita_zip!"
:ExtractKrita
if exist .\bin\krita\bin\ rmdir /s /q .\bin\krita\bin\
call :HelperExtract "!folder!\extra\!krita_zip!" "!folder!\temp\"
pushd .\temp\krita*
echo %CD%
xcopy *.* "!folder!\bin\krita\" /e /i /y
popd
...
if not exist ".\bin\krita\bin\krita.exe" set nag=KRITA IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Krita Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Krita Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Krita Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Krita Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Krita Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Krita Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
