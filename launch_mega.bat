...
:Menu
cls
title Portable Mega Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall mega [will remove mega entirely]
echo 2. launch mega [launches mega]
echo 3. reset mega [will remove everything mega except the binary]
echo 4. uninstall mega [????]
...
echo d. check for new mega version [automatically check for a new version]
...
:2
:LaunchMega
if not exist ".\bin\mega\!arch!\MEGAsync.exe" set "nag=PLEASE INSTALL MEGA FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo MEGA IS RUNNING
start .\bin\mega\!arch!\MEGAsync.exe
exit
...
if exist .\extra\MEGAsyncSetup64.exe del .\extra\MEGAsyncSetup64.exe >nul
exit /b 2
...
cls
title Portable Mega Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Mega Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Mega Launcher - Helper Edition - Download Suite
...
title Portable Mega Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start .\bin\mega\%%arch%%\MEGAsync.exe>>!quick_launcher!
...
call :HelperDownload "https://mega.nz/MEGAsyncSetup32.exe" "MEGAsyncSetup32.exe"
call :HelperDownload "https://mega.nz/MEGAsyncSetup64.exe" "MEGAsyncSetup64.exe"
:MoveMega
move MEGAsyncSetup32.exe .\extra\MEGAsyncSetup32.exe
move MEGAsyncSetup64.exe .\extra\MEGAsyncSetup64.exe
:ExtractMega
...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\MEGAsyncSetup32.exe" & echo.>".\extra\MEGAsyncSetup64.exe")
exit /b 2

:e
title Portable Mega Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\mega\!arch!\MEGAsync.exe" set nag=MEGA IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Mega Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Mega Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Mega Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Mega Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Mega Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Mega Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
