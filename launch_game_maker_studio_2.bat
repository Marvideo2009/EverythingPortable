...
:Menu
cls
title Portable Game Maker Studio 2 Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall game maker studio 2 [will remove game maker studio 2 entirely]
echo 2. launch game maker studio 2 [launches game maker studio 2]
echo 3. reset game maker studio 2 [will remove everything game maker studio 2 except the binary]
echo 4. uninstall game maker studio 2 [none of your friends on game maker studio 2?]
...
echo d. check for new game maker studio 2 version [automatically check for a new version]
...
cls
title Portable Game Maker Studio 2 Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Game Maker Studio 2 Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Game Maker Studio 2 Launcher - Helper Edition - Download Suite
...
title Portable Game Maker Studio 2 Launcher - Helper Edition - Quicklauncher Writer
...
:e
title Portable Game Maker Studio 2 Launcher - Helper Edition - Text-Reader Update Check
cls
...
echo ================================================== >> !license!
cls
title Portable Game Maker Studio 2 Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Game Maker Studio 2 Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Game Maker Studio 2 Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Game Maker Studio 2 Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Game Maker Studio 2 Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Game Maker Studio 2 Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
