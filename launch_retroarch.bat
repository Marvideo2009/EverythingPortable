...
:Menu
cls
title Portable Retroarch Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall retroarch [will remove retroarch entirely]
echo 2. launch retroarch [launches retroarch]
echo 3. reset retroarch [will remove everything retroarch except the binary]
echo 4. uninstall retroarch [switching to something else for streaming?]
...
echo d. check for new retroarch version [automatically check for a new version]
...
:ReinstallRetroarch
cls
call :UninstallRetroarch
call :UpgradeRetroarch
exit /b 2

:2
:LaunchRetroarch
if not exist ".\bin\retroarch\RetroArch-Win!arch!\retroarch.exe" set "nag=PLEASE INSTALL RETROARCH FIRST" & exit /b 2
title DO NOT CLOSE
set "Path=!PATH!;!folder!\dll\!arch!\;"
cls
echo RETROARCH IS RUNNING
cd .\bin\retroarch\RetroArch-Win!arch!\
start retroarch.exe
exit
...
cls
title Portable Retroarch Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Retroarch Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Retroarch Launcher - Helper Edition - Download Suite
...
title Portable Retroarch Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo cd .\bin\retroarch\RetroArch-Win%%arch%%\>>!quick_launcher!
echo start retroarch.exe>>!quick_launcher!
...
call :HelperDownload "https://www.retroarch.com/?page=platforms" "index.html@page=platforms"
set counter=0
:UpgradeSearchLoop
set /a counter+=1
for /f tokens^=%counter%delims^=^" %%A in (
  'findstr /i /c:"/windows/x86_64/RetroArch.7z" "index.html@page=platforms"'
) Do > .\doc\retroarch_link.txt Echo:%%A
set /p retroarch_link=<.\doc\retroarch_link.txt
if "!Debug!" EQU "1" (
  echo !retroarch_link!
  echo !counter!
)
if "!retroarch_link:~0,37!"=="https://buildbot.libretro.com/stable/" ( if "!Debug!" EQU "1" ( echo hit ) ) & goto ExitUpgradeSearchLoop
...
set "retroarch_link32=!retroarch_link:x86_64=x86!"
set "retroarch_link64=!retroarch_link!"
set "tempstr=!retroarch_link32!"
set "result=%tempstr:/=" & set "result=%"
set "retroarch_7zip32=!result!"
set "tempstr=!retroarch_link64!"
set "result=%tempstr:/=" & set "result=%"
set "retroarch_7zip64=!result!"
if "!Debug!" EQU "1" (
  cls
...
:e
title Portable Retroarch Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\retroarch\RetroArch-Win!arch!\retroarch.exe" set nag=RETROARCH IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Retroarch Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Retroarch Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Retroarch Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Retroarch Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Retroarch Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Retroarch Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
