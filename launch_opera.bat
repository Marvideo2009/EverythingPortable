...
.\bin\opera\launcher.exe https://github.com/Marvideo2009/EverythingPortable/releases/latest/
...
echo cls>>!quick_launcher!
echo .\bin\opera\launcher.exe https://github.com/Marvideo2009/EverythingPortable/releases/latest/>>!quick_launcher!
