...
:Menu
cls
title Portable Minecraft Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall minecraft [will remove minecraft entirely]
echo 2. launch minecraft [launches minecraft]
echo 3. reset minecraft [will remove everything minecraft except the binary]
echo 4. uninstall minecraft [none of your friends on minecraft?]
...
cls
title Portable Minecraft Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Minecraft Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Minecraft Launcher - Helper Edition - Download Suite
...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\MinecraftInstaller.msi")
exit /b 2

:e
title Portable Minecraft Launcher - Helper Edition - Text-Reader Update Check
cls
...
echo \data\minecraft\profiles\!Profile!>.\ini\minecraft_legacy.ini>.\ini\minecraft.ini
goto 2
:Default
cls
...
call :HelperDownload "https://raw.githubusercontent.com/Marvideo2009/EverythingPortable/master/launch_minecraft_legacy.bat" "launch_minecraft_legacy.bat.1"
...
echo ================================================== >> !license!
cls
title Portable Minecraft Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Minecraft Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Minecraft Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Minecraft Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Minecraft Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Minecraft Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
