...
:Menu
cls
title Portable Jami Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall jami [will remove jami entirely]
echo 2. launch jami [launches jami]
echo 3. reset jami [will remove everything jami except the binary]
echo 4. uninstall jami [pc too underpowered for jami?]
...
echo d. check for new jami version [automatically check for a new version]
...
:2
:LaunchJami
if not exist ".\bin\Jami\Jami.exe" set "nag=PLEASE INSTALL JAMI FIRST" & exit /b 2
title DO NOT CLOSE
set "path=!PATH!;!folder!\dll\64\;"
cls
echo JAMI IS RUNNING
pushd .\bin\Jami\
if exist "!RealUserProfile!\AppData\Local\jami\" rmdir /s /q "!RealUserProfile!\AppData\Local\jami\"
if exist ".\data\Users\MarioMasta64\AppData\Local\jami\" xcopy ".\data\Users\MarioMasta64\AppData\Local\jami\*" "!RealUserProfile!\AppData\Local\jami\" /e /i /y & rmdir /s /q ".\data\Users\MarioMasta64\AppData\Local\jami\"
Jami.exe
if exist ".\data\Users\MarioMasta64\AppData\Local\jami\" rmdir /s /q ".\data\Users\MarioMasta64\AppData\Local\jami\"
if exist "!RealUserProfile!\AppData\Local\jami\" xcopy "!RealUserProfile!\AppData\Local\jami\*" ".\data\Users\MarioMasta64\AppData\Local\jami\" /e /i /y & rmdir /s /q "!RealUserProfile!\AppData\Local\jami\"
popd
exit
...
cls
taskkill /f /im Jami.exe
if exist .\bin\jami\ rmdir /s /q .\bin\jami\
if exist .\extra\jami.release.x64.msi del .\extra\jami.release.x64.msi >nul
exit /b 2
...
cls
title Portable Jami Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Jami Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Jami Launcher - Helper Edition - Download Suite
...
title Portable Jami Launcher - Helper Edition - Quicklauncher Writer
...
cls
:UpgradeJami
title Portable Jami Launcher - Helper Edition - Jami Update Check
if exist jami.release.x64.msi del jami.release.x64.msi >nul
call :HelperDownload "https://dl.jami.net/windows/jami.release.x64.msi" "jami.release.x64.msi"
:MoveJami
if exist jami.release.x64.msi move jami.release.x64.msi .\extra\jami.release.x64.msi
:ExtractJami
call :HelperExtractMSI "!folder!\extra\jami.release.x64.msi" "!folder!\temp\"
:CopyJami
REM maybe copy also the System64 folder if required in the future
xcopy ".\temp\SourceDir\Jami\*" ".\bin\Jami\" /e /i /y
if exist .\temp\ rmdir /s /q .\temp\
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\jami.release.x64.msi")
exit /b 2

:e
cls
title Portable Jami Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\Jami\Jami.exe" set nag=JAMI IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Jami Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Jami Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Jami Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Jami Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Jami Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Jami Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
