...
:Menu
cls
title Portable Osu Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall osu [will remove osu entirely]
echo 2. launch osu [launches osu]
echo 3. reset osu [will remove everything osu except the binary] [note: osu will auto-launch]
echo 4. uninstall osu [peppy acting too sus?]
...
echo d. check for new osu version [automatically check for a new version] [note: sign-in does not currently work.]
...
:2
:LaunchOsu
if not exist ".\bin\osu^!\osu^!.exe" set "nag=PLEASE INSTALL OSU FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo OSU IS RUNNING
start "" ".\bin\osu^!\osu^!.exe"
exit
...
cls
title Portable Osu Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Osu Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Osu Launcher - Helper Edition - Download Suite
...
echo cls>>!quick_launcher!
echo start "" ".\bin\osu^!\osu^!.exe">>!quick_launcher!
...
cls
:UpgradeOsu
if exist "osu^!install.exe" del "osu^!install.exe" >nul
call :HelperDownload "https://m1.ppy.sh/r/osu%%%%21install.exe" "osu^^!install.exe"
:MoveOsu
move "osu^!install.exe" ".\extra\osu^!install.exe"
:InstallOsu
echo f | xcopy ".\extra\osu^!install.exe" ".\bin\osu^!\osu^!install.exe" /e /i /y
".\bin\osu^!\osu^!install.exe"
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\Osu^!Setup.exe")
exit /b 2

:e
title Portable Osu Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\osu^!\osu^!.exe" set nag=OSU IS NOT INSTALLED CHOOSE "D"
if exist .\bin\osu^!\ call :Releasev15Upgrade
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Osu Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Osu Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Osu Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Osu Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Osu Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Osu Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
...
if exist .\bin\osu^!\ rmdir /s /q .\bin\osu^!\
exit /b 2