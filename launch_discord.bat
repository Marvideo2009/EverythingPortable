...
:Menu
cls
title Portable Discord Launcher - Helper Edition - Main Menu
echo !NAG!
...
cls
title Portable Discord Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Discord Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Discord Launcher - Helper Edition - Download Suite
...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\DiscordSetup.exe")
exit /b 2
:ExtractDiscord
...
echo ================================================== >> !license!
cls
title Portable Discord Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Discord Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Discord Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:PreviewBuild
cls
title Portable Discord Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Discord Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
