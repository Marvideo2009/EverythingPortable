...
:2
:LaunchTor
if not exist ".\bin\tor\firefox.exe" set "nag=PLEASE INSTALL TOR FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo TOR IS RUNNING
cd .\bin\tor\
start firefox.exe "https://github.com/Marvideo2009/EverythingPortable/"
REM start firefox.exe "https://github.com/Marvideo2009/EverythingPortable/" -profile "!folder!\data\tor"
cd "!folder!"
exit
...
echo start firefox.exe "https://github.com/Marvideo2009/EverythingPortable/">>!quick_launcher!
...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\!tor_exe!")
exit /b 2
