...
echo 3. reset vlc [will remove everything vlc except the binary]
echo 4. uninstall vlc [prefer something else like media player classic?]
...
echo d. check for new vlc version [automatically check for a new version]
echo e. install text-reader [update if had]
echo.
echo f. download dvd ^& bluray keys
echo.
...
:2
:LaunchVLC
if not exist ".\bin\vlc\!arch!\vlc.exe" set "nag=PLEASE INSTALL VLC FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo VLC IS RUNNING
start "" ".\bin\vlc\!arch!\vlc.exe"
exit
...
if exist .\data\Users\MarioMasta64\AppData\Roaming\vlc\ rmdir /s /q .\data\Users\MarioMasta64\AppData\Roaming\vlc\
exit /b 2
...
cls
taskkill /f /im vlc.exe
if exist .\bin\vlc\ rmdir /s /q .\bin\vlc\
if exist .\extra\*vlc* del .\extra\*vlc* >nul
exit /b 2
...
cls
title Portable VLC Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable VLC Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable VLC Launcher - Helper Edition - Download Suite
...
title Portable VLC Launcher - Helper Edition - Quicklauncher Writer
...
call :HelperDownload "https://www.videolan.org/vlc/" "index.html"
set counter=0
:UpgradeSearchLoop
set /a counter+=1
...
if exist index.html del index.html >nul
set "vlc_link=https:!vlc_link:\/=/!"
set "vlc_link32=!vlc_link:win64=win32!"
set "vlc_link64=!vlc_link:win32=win64!"
set "tempstr=!vlc_link!"
...
cls
echo upgrading to vlc v!vlc_exe:~4,-10!
call :HelperDownload "!vlc_link32!" "!vlc_exe32!"
call :HelperDownload "!vlc_link64!" "!vlc_exe64!"
:MoveVLC
move "!vlc_exe32!" ".\extra\!vlc_exe32!"
move "!vlc_exe64!" ".\extra\!vlc_exe64!"
:ExtractVLC
call :HelperExtract7Zip "!folder!\extra\!vlc_exe32!" "!folder!\bin\vlc\32\"
...
:e
cls
title Portable VLC Launcher - Helper Edition - Text-Reader Update Check
cls
...
move libdvdcss-2.dll .\bin\vlc\32\libdvdcss-2.dll
call :HelperDownload "https://download.videolan.org/libdvdcss/1.2.11/win64/libdvdcss-2.dll" "libdvdcss-2.dll"
move libdvdcss-2.dll .\bin\vlc\64\libdvdcss-2.dll
:DownloadKEYDB
if not exist .\data\Users\MarioMasta64\AppData\Roaming\aacs\ mkdir .\data\Users\MarioMasta64\AppData\Roaming\aacs\
call :HelperDownload "http://fvonline-db.bplaced.net/fv_download.php?lang=eng" "fv_download.php@lang=eng"
:MoveKEYDB
move "fv_download.php@lang=eng" ".\extra\KEYDB.zip"
:ExtractKEYDB
call :HelperExtract "!folder!\extra\KEYDB.zip" "!folder!\data\Users\MarioMasta64\AppData\Roaming\aacs\"
:DownloadLibAACS
if exist .\bin\vlc\32\libbdplus.dll exit /b 2
if not exist .\extra\2020-07-26_libaacs_libbdplus.7z call :HelperDownload "https://mariomasta64.me/misc/2020-07-26_libaacs_libbdplus.7z" "2020-07-26_libaacs_libbdplus.7z"
:VerifyLibAACS
set /a count=1
for /f "skip=1 delims=:" %%a in ('CertUtil -hashfile "!folder!\2020-07-26_libaacs_libbdplus.7z" SHA256') do (
  if !count! equ 1 set "hash=%%a"
  set /a count+=1
)
echo !hash!
set "hash=%hash: =%"
if "!hash!" equ "00d35d177c95f17d14e84f75a4ca19605073f790befa0f9a835c7ed0a2479797" goto MoveLibAACS
del 2020-07-26_libaacs_libbdplus.7z
cls
echo LibAACS Hash Does Not Match (Press "5" To Check For Launcher Updates And Re-Run "d" If One Is Found)
goto DownloadLibDVDCSS
:MoveLibAACS
move 2020-07-26_libaacs_libbdplus.7z .\extra\2020-07-26_libaacs_libbdplus.7z
:ExtractLibAACS
call :HelperExtract7Zip "!folder!\extra\2020-07-26_libaacs_libbdplus.7z" "!folder!\temp\"
:CopyLibAACS
xcopy .\temp\2020-07-26_libaacs_libbdplus\win32\* .\bin\vlc\32\ /e /i /y
xcopy .\temp\2020-07-26_libaacs_libbdplus\win64\* .\bin\vlc\64\ /e /i /y
...
echo ================================================== >> !license!
cls
title Portable VLC Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable VLC Launcher - Helper Edition - Latest Build :D
...
:PreviewBuild
cls
title Portable VLC Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable VLC Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
